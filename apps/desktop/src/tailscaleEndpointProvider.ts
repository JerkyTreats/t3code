...
function createTailscaleEndpoint(input: {
  readonly id: string;
  ...
  readonly hostedHttpsCompatibility?: AdvertisedEndpoint["hostedHttpsCompatibility"];
}): AdvertisedEndpoint {
  return {
    id: input.id,
    label: input.label,
    ...
    ...(input.hostedHttpsCompatibility === undefined
      ? {}
      : { hostedHttpsCompatibility: input.hostedHttpsCompatibility }),
