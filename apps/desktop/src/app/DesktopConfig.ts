...
export const DesktopConfig = Config.all({
  ...
  standaloneServerUrl: Config.url("T3CODE_DESKTOP_SERVER_URL").pipe(Config.option),
  legacyStagingServerUrl: Config.url("T3CODE_DESKTOP_STAGING_SERVER_URL").pipe(Config.option),
