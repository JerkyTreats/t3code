...
export const DEFAULT_KEYBINDINGS: ReadonlyArray<KeybindingRule> = [
  ...
  { key: "mod+t", command: "preview.new", when: "previewFocus" },
  { key: "mod+w", command: "preview.close", when: "previewFocus" },
  { key: "mod+shift+t", command: "preview.reopenClosed", when: "previewFocus" },
