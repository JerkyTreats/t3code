...
export const RelayClientGroup = HttpApiGroup.make("client")
  .add(
    ...
    HttpApiEndpoint.delete(
      ...
      .annotate(OpenApi.Summary, "Release an environment managed tunnel")
      .annotate(
        OpenApi.Description,
        "Release the current managed tunnel while retaining the environment link and stable endpoint reservation for the next startup.",
      ),
  )
