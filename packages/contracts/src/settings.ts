...
export const ClientSettingsSchema = Schema.Struct({
  ...
  // Keep explicit user choice separate so the stored default is not treated as an opt-out.
...
export const CodexSettings = makeProviderSettingsSchema(
  {
    ...
    launchArgs: TrimmedString.pipe(
      ...
      Schema.annotateKey({
        ...
        description: "Global Codex CLI arguments passed before the selected subcommand.",
        providerSettingsForm: {
          placeholder: "--strict-config --enable feature",
          clearWhenEmpty: "omit",
        },
      }),
    ),
