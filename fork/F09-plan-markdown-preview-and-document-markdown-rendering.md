...
- `apps/web/src/components/FilePreviewSurface.tsx`
- `apps/web/src/components/ProjectFilePreviewSurface.tsx`
...
- `apps/web/src/components/files-panel/ProjectExplorerTree.tsx`
